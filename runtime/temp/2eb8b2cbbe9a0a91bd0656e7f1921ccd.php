<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/www/wwwroot/yangming/public/../application/console/view/auth_group/index.html";i:1516943998;s:66:"/www/wwwroot/yangming/application/console/view/public_sidebar.html";i:1517903988;s:65:"/www/wwwroot/yangming/application/console/view/public_header.html";i:1516943998;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="contentpanel">
            <div class="panel panel-default">
                <div class="panel-heading" style="border-bottom:none;">
                    <div>
                        <a class="btn btn-primary" href="<?php echo url('add'); ?>"
                ...
                <div class="panel-heading">
                    <form name="form" method="get" action="">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" placeholder="搜索-标题" class="form-control" name="keyword"
                    ...
                    <form name="form" id="form" method="post" action="">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tr class="modules">
                                ...
                                <td>
                                    <a href="<?php echo url('edit',['console_auth_group_id'=>$item['id']]); ?>"><i
                                            class="fa fa-pencil"></i>&nbsp;编辑</a>
                                    <a href="<?php echo url('delete',['console_auth_group_id'=>$item['id']]); ?>"
                                       onClick="return confirm('确认删除?')"><span class="glyphicon glyphicon-trash"></span>&nbsp;删除</a>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
